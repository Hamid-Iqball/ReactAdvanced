...
function handleChange(i){
    ...
    return <div>
        ...
        <ul className="from-neutral-600 bg-orange-300 grid grid-cols-2">
           {posts.map((post, index) => (
            <>
            <div className="flex">

            <li key={post.index} className="border my-2 p-2 mx-2 bg-orange-100 rounded-sm">{post.title} {showDescription[index] &&  <p className="m-2"> {post.body}</p>}
